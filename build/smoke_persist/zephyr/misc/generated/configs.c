...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FS_LITTLEFS_CACHE_SIZE, 32);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FS_LITTLEFS_LOOKAHEAD_SIZE, 8);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FS_LITTLEFS_BLOCK_CYCLES, 16);
